      ...
      >
        ...
        <div className="h-[80vh] w-full overflow-hidden rounded-lg flex items-center justify-center bg-gray-900">
          <div className="text-center text-white p-8">
            <p className="text-xl mb-4">Сказитель 🪆</p>
            <p className="text-gray-400">Скоро здесь оживёт наш сказитель — расскажет былину или загадает загадку.</p>
            <p className="text-gray-500 mt-4 text-sm">Напишите нам: skazki@folklore.ru</p>
          </div>
        </div>
      </div>
    </div>
